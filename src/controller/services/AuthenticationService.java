...
public class AuthenticationService {
    ...
    // Bonus Implementation: SHA-256 Hashing
    ...
    public static boolean validateEmailFormat(String email) {
        ...
        // Validate Domain
        // Must have at least one dot, extension >= 2 letters, start/end with letter/number, no double dots
        String domainRegex = "^[a-zA-Z0-9][a-zA-Z0-9.-]*\\.[a-zA-Z]{2,}$";
        if (!Pattern.matches(domainRegex, domain) || domain.contains("..")) {
            return false;
        }
